...
public class UserController {
    ...
    @GetMapping(value = "/{myUserId}", produces = MediaType.APPLICATION_JSON_VALUE)
    public UserResponse<User> getUser(@PathVariable("myUserId") String userId){
        System.out.println("UserController -> getUser");
        return userService.getUser(userId);
    }

    @GetMapping(value = "/searchByPhone", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "/{myUserId}", produces = MediaType.APPLICATION_JSON_VALUE)
