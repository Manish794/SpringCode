...
public class UserController {
    ...
    @GetMapping(value="/generatePDFReport",produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public UserResponse<String> generatePDFReport(){
        System.out.println("UserController -> generatePDFReport");
        return userService.generatePDFReport();
    }
